...
<svg class="logo" x="0px" y="0px" viewBox="0 0 301 94" >
    <g>
        <g>
            <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M29.5,18.5c-2.4,0.1-6.9-1.4-9.1-2.1c-2.2-0.7-4-1.4-6.3-1.7c-7.1-1-10.4,3.5-10.4,6.6c0,2.6,2.1,4.6,3.7,4.9
...
c8.5,0,16,2.6,19.6,2.6c6.3-0.3,6.8-2.6,7.7-2.6c0.2,0,0.3,0.2,0.3,0.4c0,0.3-0.1,0.6-0.2,0.9C48.3,7.3,40.4,17.9,29.5,18.5z" />
            <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M92.5,6.4c-0.1-2.1-4.8-1-5.2-1c0-2.6-1.8-3.7-0.7-4.1c3.4-1.3,8-1.1,7.8,5.3c-0.2,7-10.1,14.8-13.3,15.4
...
c4.3,0,8.3-2.5,8.9-5.5C92.4,7.2,92.5,6.9,92.5,6.4z" />
        ...
        <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M114.8,74.7c-2.1,0-10.3-3.5-10.3-5v-0.2c-2.9,1.5-5.8,7.3-5.2,7.3c-0.7,0-0.2-3.3-6.1-5.7
...
L104.7,52.8z" />
        <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M162.8,31.8c0.3,3.8-1,7.1-3.4,10.8c-2.7,4.1-8.6,7.9-9.7,7.9c-0.8,0-5.6-3.9-7.7-7v23.3
...
C157.5,27.8,162.5,27.6,162.8,31.8z" />
        <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M208.7,85.2c-2.3,3.1,1.7,6.2,5.6,4.4c1.1-0.5,4.2-2.5,4.2-2.5s0.2,2.3,0,3.2c-0.2,0.8-0.5,1.7-0.8,2.1
...
c-2.1-8-9.2-9.8-10.1-9.9c-0.3,0-0.5-0.1-0.7-0.1c-0.7,0-20.1,18.8-19.8,18.8C193.8,73.1,198,75.1,203.5,76.1z" />
        <g>
            <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M248.9,76.3c-2.8-3.9-7.8-5.9-11.1-6.5c2.4,0,3.5-1.5,3.5-3.2V41.7c0-1.1-1.8-1.4-3.6-1.8
...
C253,70.6,250.2,73.5,248.9,76.3z" />
            <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M238.3,20.1c-0.1-0.1-0.1-0.2-0.1-0.3s0.1-0.3,0.3-0.4c0.3-0.3,0.7-0.5,0.8-0.3l1.5,1.5
...
c-3,1.6-6.1,5.5-7.2,8.7C245.3,26.3,240.8,22.6,238.3,20.1z" />
        ...
        <path :fill="$store.state.page.pageFeatures.darkMode  || $store.state.nav.menuOpen || forceWhite ? '#fff' : '#000'" d="M291.1,75.6c-1.9-2.5-6.3-5.8-9.1-6c2.4-0.8,3.3-2.6,3.3-4V43.1c0-2.4-1.8-3.3-3.1-3.3c-0.4,0-0.8,0.1-0.9,0.3
