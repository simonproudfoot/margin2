...
export default {
    ...
    //   //  navStore.updateMainNav()
    //     const pageStore = usePageData()
    //     const menu = navStore ?.mainNav ?.data ?.items.sort((a, b) => a.menu_order - b.menu_order)
    //     return {
    //         pageStore,
    //         navStore,
    //         menu
